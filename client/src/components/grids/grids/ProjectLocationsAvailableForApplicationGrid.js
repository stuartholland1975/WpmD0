...
const ProjectLocationsAvailableForApplicationGrid = ({setItemData}) => {
    ...
    const {data: itemData, loading} = useQuery(GET_PROJECT_ITEMS_AVAILABLE_FOR_APPLICATION, {
    ...
    const onSelectionChanged = React.useCallback(() => {
        ...
        setItemData(itemData.wpmGraphqlGetItemsAvailableForApplication.nodes.filter(f => selectedRow.some(item => item.id === f.sitelocationId)))
